...
//             }, setResult({ ...result, chipsSaved: true }))
//             .catch(error => {
//                 console.log(error)
//             })
...
//             </div>
//             <span className="waves-input-wrapper waves-effect waves-light"><input onClick={handleSubmitbutton} type="submit" value="Submit" className="btn btn-success" /></span>
